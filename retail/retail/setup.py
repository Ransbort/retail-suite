...
def get_custom_fields():
	return {
		"POS Profile": [
			...
			{"fieldname": "posa_printer_ip", "label": "Printer IP", "fieldtype": "Data", 'reqd': 1, "insert_after": "posa_printer_settings_section", "reqd": 1},
			{"fieldname": "posa_printer_port", "label": "Printer Port", "fieldtype": "Int", 'reqd': 1, "insert_after": "posa_printer_ip", "reqd": 1},
			{"fieldname": "posa_printer_type", "label": "Printer Type", "fieldtype": "Select", 'reqd': 1, "insert_after": "posa_printer_port", "options": "\nThermal Printer\nLaser Printer\nInkjet Printer", "reqd": 1},
